###########################################################################
## Makefile generated for Simulink model 'Vehicle'. 
## 
## Makefile     : Vehicle.mk
## Generated on : Fri May 11 03:34:46 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Vehicle.exe
...
MODELREF_LINK_RSPFILE_NAME = Vehicle_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Vehicle_ref.rsp
CMD_FILE                  = Vehicle.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Vehicle.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Vehicle_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Vehicle -DNUMST=2 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Vehicle_grt_rtw/Vehicle.c $(START_DIR)/Vehicle_grt_rtw/Vehicle_data.c $(START_DIR)/Vehicle_grt_rtw/rtGetInf.c $(START_DIR)/Vehicle_grt_rtw/rtGetNaN.c $(START_DIR)/Vehicle_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj Vehicle.obj Vehicle_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/Vehicle_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Vehicle_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

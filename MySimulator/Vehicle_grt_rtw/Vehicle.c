...
static void Vehicle_automlvehdynftiresat(real_T Ftire_x, real_T Ftire_y, real_T
  ...
  b_Fxtire_sat, real_T b_Fytire_sat, real_T *Ftire_xs, real_T *Ftire_ys)
{
  ...
  Ftire_x_max = b_Fxtire_sat * cos(theta_Ftire);
  Ftire_mag = b_Fytire_sat * sin(theta_Ftire);
  Ftire_mag = b_Fxtire_sat * b_Fytire_sat / sqrt(Ftire_x_max * Ftire_x_max +
    Ftire_mag * Ftire_mag);
  Ftire_x_max = Ftire_mag * sin(theta_Ftire);
  theta_Ftire = Ftire_mag * cos(theta_Ftire);
  *Ftire_xs = Ftire_x;
  if (fabs(Ftire_x) > fabs(Ftire_x_max)) {
...
void Vehicle_step(void)
{
  ...
  int32_T loop_ub;
  int32_T i_0;
  real_T rtb_VectorConcatenate_ml[3];
  real_T rtb_VectorConcatenate2;
  real_T rtb_VectorConcatenate1_p_idx_2;
  real_T rtb_VectorConcatenate2_idx_1;
  real_T rtb_VectorConcatenate1_p_idx_1;
  real_T rtb_VectorConcatenate1_p_idx_0;
  real_T rtb_VectorConcatenate2_idx_0;
  real_T Fz_idx_0;
  real_T Fz_idx_1;
  real_T rtb_Sum_tmp;
  real_T rtb_Product2_l_tmp;
  real_T rtb_Product_e_tmp;
  ...
  /* Outport: '<Root>/XY Positions' incorporates:
   *  Integrator: '<S28>/Integrator'
   */
  Vehicle_Y.XYPositions[0] = Vehicle_X.Integrator_CSTATE[0];
  Vehicle_Y.XYPositions[1] = Vehicle_X.Integrator_CSTATE[1];

  /* Fcn: '<Root>/Fcn' incorporates:
   *  Inport: '<Root>/Steering Angle'
   */
  rtb_Fcn = 3.1415926535897931 * Vehicle_U.SteeringAngle / 180.0;
  if (rtmIsMajorTimeStep(Vehicle_M)) {
    /* SignalConversion: '<S56>/ConcatBufferAtVector Concatenate1In1' incorporates:
     *  Constant: '<S56>/Constant'
     */
    Vehicle_B.VectorConcatenate1[0] = Vehicle_P.Constant_Value;

    /* SignalConversion: '<S56>/ConcatBufferAtVector Concatenate1In2' incorporates:
     *  Constant: '<S56>/Constant'
     */
    Vehicle_B.VectorConcatenate1[1] = Vehicle_P.Constant_Value;

    /* UnitConversion: '<S60>/Unit Conversion1' incorporates:
     *  Constant: '<S1>/Constant'
     */
    /* Unit Conversion - from: N to: N
       Expression: output = (1*input) + (0) */
    Vehicle_B.VectorConcatenate1_c[0] = Vehicle_P.Constant_Value_d;

    /* SignalConversion: '<S60>/ConcatBufferAtVector Concatenate1In2' */
    Vehicle_B.VectorConcatenate1_c[1] = 0.0;

    /* Constant: '<S86>/xdot_o' */
    Vehicle_B.VectorConcatenate[0] = Vehicle_P.BicycleModelVelocityInput_xdot_;
  ...
  if (Vehicle_DW.Integrator_IWORK_c != 0) {
    Vehicle_X.Integrator_CSTATE_p[0] = Vehicle_B.VectorConcatenate[0];
    Vehicle_X.Integrator_CSTATE_p[1] = Vehicle_B.VectorConcatenate[1];
    Vehicle_X.Integrator_CSTATE_p[2] = Vehicle_B.VectorConcatenate[2];
    Vehicle_X.Integrator_CSTATE_p[3] = Vehicle_B.VectorConcatenate[3];
  }
   ...
   */
  rtb_Product_e_tmp = sin(Vehicle_X.Integrator_CSTATE_p[2]);
  rtb_Product2_l_tmp = cos(Vehicle_X.Integrator_CSTATE_p[2]);
  if (rtmIsMajorTimeStep(Vehicle_M)) {
   ...
   */
  rtb_VectorConcatenate1_p_idx_0 = Vehicle_X.Integrator_CSTATE_p[0] -
    (rtb_Product2_l_tmp * Vehicle_B.VectorConcatenate1_n[0] + rtb_Product_e_tmp *
     Vehicle_B.VectorConcatenate1_n[1]);
  rtb_VectorConcatenate1_p_idx_1 = Vehicle_X.Integrator_CSTATE_p[1] -
    (rtb_Product2_l_tmp * Vehicle_B.VectorConcatenate1_n[1] - rtb_Product_e_tmp *
     Vehicle_B.VectorConcatenate1_n[0]);

  /* Switch: '<S20>/Switch' incorporates:
   *  Constant: '<S20>/Constant4'
   */
  if (rtb_VectorConcatenate1_p_idx_0 >= Vehicle_P.Switch_Threshold) {
    rtb_VectorConcatenate2_idx_0 = Vehicle_P.Constant4_Value[0];
  } else {
    rtb_VectorConcatenate2_idx_0 = Vehicle_B.UnaryMinus[0];
  }

  if (rtb_VectorConcatenate1_p_idx_1 >= Vehicle_P.Switch_Threshold) {
    rtb_VectorConcatenate2_idx_1 = Vehicle_P.Constant4_Value[1];
  } else {
    rtb_VectorConcatenate2_idx_1 = Vehicle_B.UnaryMinus[1];
  }
   ...
   */
  rtb_Sum = sqrt((rtb_VectorConcatenate1_p_idx_0 *
                  rtb_VectorConcatenate1_p_idx_0 +
  ...
  rtb_Sum = rt_atan2d_snf(rtb_VectorConcatenate1_p_idx_1,
    rtb_VectorConcatenate1_p_idx_0);

  /* Lookup_n-D: '<S20>/Cs' */
  Vehicle_B.VectorConcatenate_b[1] = look1_binlcpw(rtb_Sum,
  ...
  /* Lookup_n-D: '<S20>/Crm' */
  Vehicle_B.VectorConcatenate_b[3] = look1_binlxpw(rtb_Sum,
    Vehicle_P.Crm_bp01Data, Vehicle_P.Crm_tableData, 1U);

  /* Product: '<S20>/Product5' incorporates:
   *  Constant: '<S20>/Constant2'
   */
  Vehicle_B.VectorConcatenate_b[4] = rtb_VectorConcatenate2_idx_0 *
    Vehicle_P.BicycleModelVelocityInput_Cpm;

  /* Lookup_n-D: '<S20>/Cym' */
  Vehicle_B.VectorConcatenate_b[5] = look1_binlxpw(rtb_Sum,
    Vehicle_P.BicycleModelVelocityInput_beta_,
   ...
   */
  rtb_Sum = 0.5 * Vehicle_P.BicycleModelVelocityInput_Af *
    Vehicle_P.BicycleModelVelocityInput_Pabs / Vehicle_P.DragForce_R /
    Vehicle_P.BicycleModelVelocityInput_Tair;
  for (i = 0; i < 6; i++) {
    rtb_uAPabsRT[i] = rtb_Product_e * Vehicle_B.VectorConcatenate_b[i] * rtb_Sum;
  }
   ...
   *  MATLAB Function: '<S2>/vehicle model'
   */
  rtb_Sum_tmp = Vehicle_P.lf + Vehicle_P.lr;

  /* Product: '<S20>/Product3' incorporates:
   *  UnaryMinus: '<S4>/Unary Minus'
   */
  rtb_VectorConcatenate2_idx_0 = -(rtb_VectorConcatenate2_idx_0 * rtb_uAPabsRT[0]);
   ...
   */
  rtb_VectorConcatenate1_p_idx_1 = -(rtb_uAPabsRT[4] * rtb_Sum_tmp);

  /* Product: '<S20>/Product3' incorporates:
   *  UnaryMinus: '<S4>/Unary Minus'
   */
  rtb_VectorConcatenate2_idx_1 = -(rtb_VectorConcatenate2_idx_1 * rtb_uAPabsRT[1]);
  ...
  if (0.0 - Vehicle_B.VectorConcatenate1_n[2] >= Vehicle_P.Switch_Threshold) {
    rtb_VectorConcatenate1_p_idx_0 = Vehicle_P.Constant4_Value[2];
  } else {
    rtb_VectorConcatenate1_p_idx_0 = Vehicle_B.UnaryMinus[2];
  }

  /* UnaryMinus: '<S4>/Unary Minus' incorporates:
   *  Product: '<S20>/Product3'
   */
  rtb_VectorConcatenate2 = -(rtb_VectorConcatenate1_p_idx_0 * rtb_uAPabsRT[2]);
   ...
   *  UnaryMinus: '<S4>/Unary Minus1'
   */
  rtb_VectorConcatenate1_p_idx_2 = -(rtb_uAPabsRT[5] * rtb_Sum_tmp);
   ...
   *  Sum: '<S20>/Sum of Elements'
   */
  rtb_Product_e = Vehicle_X.Integrator_CSTATE_p[3];
  rtb_VectorConcatenate1_p_idx_0 = Vehicle_P.lf * Vehicle_X.Integrator_CSTATE_p
    [3] + Vehicle_X.Integrator_CSTATE_p[1];
  alfa_f = Vehicle_X.Integrator_CSTATE_p[0] * Vehicle_X.Integrator_CSTATE_p[0];
  rtb_VectorConcatenate1_p_idx_0 = sqrt(rtb_VectorConcatenate1_p_idx_0 *
    rtb_VectorConcatenate1_p_idx_0 + alfa_f);
  rtb_Sum = Vehicle_X.Integrator_CSTATE_p[1] - Vehicle_P.lr *
    Vehicle_X.Integrator_CSTATE_p[3];
  rtb_Sum = sqrt(rtb_Sum * rtb_Sum + alfa_f);
  alfa_r = fabs(Vehicle_X.Integrator_CSTATE_p[0]);
  i = 0;
  if (alfa_r < Vehicle_P.BicycleModelVelocityInput_xdo_c) {
    i = 1;
  }

  loop_ub = i - 1;
  for (i_0 = 0; i_0 <= loop_ub; i_0++) {
    Fz_idx_0 = alfa_r / Vehicle_P.BicycleModelVelocityInput_xdo_c;
  }
  ...
  loop_ub = i - 1;
  for (i = 0; i <= loop_ub; i++) {
    Fz_idx_1 = 2.0 * Vehicle_P.BicycleModelVelocityInput_xdo_c / (3.0 - Fz_idx_1);
  }
  ...
  i = 0;
  if (Vehicle_X.Integrator_CSTATE_p[0] < 0.0) {
    i = 1;
  }
  ...
  if (alfa_r <= Vehicle_P.BicycleModelVelocityInput_xdo_c) {
    alfa_r = tanh(4.0 * fabs(Vehicle_X.Integrator_CSTATE_p[1]));
    alfa_f = (rt_atan2d_snf(Vehicle_P.lf * Vehicle_X.Integrator_CSTATE_p[3] +
               Vehicle_X.Integrator_CSTATE_p[1], Fy_r) - rtb_Fcn) * alfa_r;
    alfa_r *= rt_atan2d_snf(Vehicle_X.Integrator_CSTATE_p[1] - Vehicle_P.lr *
      Vehicle_X.Integrator_CSTATE_p[3], Fy_r) - tanh(4.0 *
      Vehicle_X.Integrator_CSTATE_p[1]) * 0.0;
  } else {
    alfa_f = rt_atan2d_snf(Vehicle_P.lf * Vehicle_X.Integrator_CSTATE_p[3] +
      Vehicle_X.Integrator_CSTATE_p[1], Fy_r) - rtb_Fcn;
    alfa_r = rt_atan2d_snf(Vehicle_X.Integrator_CSTATE_p[1] - Vehicle_P.lr *
      Vehicle_X.Integrator_CSTATE_p[3], Fy_r);
  }
  ...
  for (i = 0; i < 6; i++) {
    if (i == 0) {
      Fy_r = rtb_VectorConcatenate2_idx_0 *
        Vehicle_P.BicycleModelVelocityInput_h;
      Fz_idx_0 = (((Vehicle_P.BicycleModelVelocityInput_g * Vehicle_P.lr *
                    Vehicle_P.m + rtb_VectorConcatenate2 * Vehicle_P.lr) + Fy_r)
                  - rtb_VectorConcatenate1_p_idx_1) / rtb_Sum_tmp;
      Fz_idx_1 = (((Vehicle_P.BicycleModelVelocityInput_g * Vehicle_P.lf *
                    Vehicle_P.m + rtb_VectorConcatenate2 * Vehicle_P.lf) - Fy_r)
                  + rtb_VectorConcatenate1_p_idx_1) / rtb_Sum_tmp;
      if (Fz_idx_0 < 0.0) {
        Fz_idx_0 = 0.0;
      }
    ...
    Fy_r = -Vehicle_P.Cr * alfa_r * Vehicle_B.VectorConcatenate1[1] * Fz_idx_1 /
      Vehicle_P.BicycleModelVelocityInput_Fznom;
    Vehicle_automlvehdynftiresat(Vehicle_B.VectorConcatenate1_c[0], Fy_f,
      Vehicle_P.vehiclemodel_Fxtire_sat * Fz_idx_0 /
      Vehicle_P.BicycleModelVelocityInput_Fznom,
      Vehicle_P.vehiclemodel_Fytire_sat * Fz_idx_0 /
      Vehicle_P.BicycleModelVelocityInput_Fznom, &Fx_f, &b_Fy_ft);
    Vehicle_automlvehdynftiresat(Vehicle_U.EgoVelocity, Fy_r,
      Vehicle_P.vehiclemodel_Fxtire_sat * Fz_idx_1 /
      Vehicle_P.BicycleModelVelocityInput_Fznom,
      Vehicle_P.vehiclemodel_Fytire_sat * Fz_idx_1 /
      Vehicle_P.BicycleModelVelocityInput_Fznom, &Fx_r, &yddot);
    Fz_idx_0 = sin(rtb_Fcn);
    Fz_idx_1 = cos(rtb_Fcn);
    Fx_f = Fx_f * Fz_idx_1 - b_Fy_ft * Fz_idx_0;
    Fy_f = -Fx_f * Fz_idx_0 + Fy_f * Fz_idx_1;
    Fx_r -= yddot * 0.0;
    Fy_r += -Fx_r * 0.0;
    b_Fy_ft = Vehicle_X.Integrator_CSTATE_p[1] * rtb_Product_e;
    Fx_r = (((Fx_f + Fx_r) - Vehicle_P.BicycleModelVelocityInput_g * 0.0) +
            rtb_VectorConcatenate2_idx_0) / Vehicle_P.m + b_Fy_ft;
    yddot = ((Fy_f + Fy_r) + rtb_VectorConcatenate2_idx_1) / Vehicle_P.m +
      -Vehicle_X.Integrator_CSTATE_p[0] * rtb_Product_e;
    Fy_f = ((Vehicle_P.lf * Fy_f - Vehicle_P.lr * Fy_r) +
            rtb_VectorConcatenate1_p_idx_2) / Vehicle_P.Iz;
    Fy_r = (Fx_r - b_Fy_ft) * Vehicle_P.BicycleModelVelocityInput_h;
    Fz_idx_0 = ((((Vehicle_P.BicycleModelVelocityInput_g * Vehicle_P.lr - Fy_r) *
                  Vehicle_P.m + rtb_VectorConcatenate2 * Vehicle_P.lr) +
                 rtb_VectorConcatenate2_idx_0 *
                 Vehicle_P.BicycleModelVelocityInput_h) -
                rtb_VectorConcatenate1_p_idx_1) / rtb_Sum_tmp;
    Fz_idx_1 = ((((Fy_r + Vehicle_P.BicycleModelVelocityInput_g * Vehicle_P.lf) *
                  Vehicle_P.m + rtb_VectorConcatenate2 * Vehicle_P.lf) -
                 rtb_VectorConcatenate2_idx_0 *
                 Vehicle_P.BicycleModelVelocityInput_h) +
                rtb_VectorConcatenate1_p_idx_1) / rtb_Sum_tmp;
    if (Fz_idx_0 < 0.0) {
  ...
  Vehicle_B.yOut[0] = Vehicle_X.Integrator_CSTATE_p[0];
  Vehicle_B.yOut[1] = Vehicle_X.Integrator_CSTATE_p[1];
  Vehicle_B.yOut[2] = Fx_r;
  Vehicle_B.yOut[3] = yddot;
  Vehicle_B.yOut[4] = Vehicle_X.Integrator_CSTATE_p[0] * rtb_Product2_l_tmp -
    Vehicle_X.Integrator_CSTATE_p[1] * rtb_Product_e_tmp;
  Vehicle_B.yOut[5] = Vehicle_X.Integrator_CSTATE_p[0] * rtb_Product_e_tmp +
    Vehicle_X.Integrator_CSTATE_p[1] * rtb_Product2_l_tmp;
  Vehicle_B.yOut[6] = Vehicle_X.Integrator_CSTATE_p[2];
  Vehicle_B.yOut[7] = Vehicle_X.Integrator_CSTATE_p[3];
  Vehicle_B.yOut[8] = rtb_VectorConcatenate1_p_idx_0 * cos(alfa_f);
  Vehicle_B.yOut[9] = rtb_VectorConcatenate1_p_idx_0 * sin(alfa_f);
  Vehicle_B.yOut[10] = rtb_Sum * cos(alfa_r);
  Vehicle_B.yOut[11] = atan(Vehicle_X.Integrator_CSTATE_p[1] /
    Vehicle_X.Integrator_CSTATE_p[0]);
  Vehicle_B.yOut[12] = rtb_Sum * sin(alfa_r);
  Vehicle_B.yOut[13] = alfa_f;
  Vehicle_B.yOut[14] = alfa_r;
  Vehicle_B.stateDer[0] = Fx_r;
  Vehicle_B.stateDer[1] = yddot;
  Vehicle_B.stateDer[2] = Vehicle_X.Integrator_CSTATE_p[3];
   ...
   */
  rtb_Fcn = sin(Vehicle_P.Constant7_Value);
  rtb_VectorConcatenate1_p_idx_1 = cos(Vehicle_P.Constant7_Value);
  rtb_VectorConcatenate2_idx_0 = sin(Vehicle_P.Constant2_Value);
  rtb_VectorConcatenate2_idx_1 = cos(Vehicle_P.Constant2_Value);
   ...
   *  Fcn: '<S31>/Fcn22'
   */
  Fy_f = rtb_VectorConcatenate2_idx_0 * rtb_Fcn;
  rtb_VectorConcatenate_l[1] = Fy_f * rtb_Product2_l_tmp -
    rtb_VectorConcatenate2_idx_1 * rtb_Product_e_tmp;

  /* Fcn: '<S31>/Fcn31' incorporates:
   *  Fcn: '<S31>/Fcn32'
   */
  Fx_r = rtb_VectorConcatenate2_idx_1 * rtb_Fcn;
  rtb_VectorConcatenate_l[2] = Fx_r * rtb_Product2_l_tmp +
    rtb_VectorConcatenate2_idx_0 * rtb_Product_e_tmp;
  ...
  /* Fcn: '<S31>/Fcn22' */
  rtb_VectorConcatenate_l[4] = Fy_f * rtb_Product_e_tmp +
    rtb_VectorConcatenate2_idx_1 * rtb_Product2_l_tmp;

  /* Fcn: '<S31>/Fcn32' */
  rtb_VectorConcatenate_l[5] = Fx_r * rtb_Product_e_tmp -
    rtb_VectorConcatenate2_idx_0 * rtb_Product2_l_tmp;

  /* Fcn: '<S31>/Fcn13' */
  rtb_VectorConcatenate_l[6] = -rtb_Fcn;

  /* Fcn: '<S31>/Fcn23' */
  rtb_VectorConcatenate_l[7] = rtb_VectorConcatenate2_idx_0 *
    rtb_VectorConcatenate1_p_idx_1;

  /* Fcn: '<S31>/Fcn33' */
  rtb_VectorConcatenate_l[8] = rtb_VectorConcatenate2_idx_1 *
    rtb_VectorConcatenate1_p_idx_1;
  if (rtmIsMajorTimeStep(Vehicle_M)) {
    /* Constant: '<S29>/R_T1' */
   ...
   *  Sum: '<S34>/Sum'
   */
  rtb_Product_e_tmp = Vehicle_B.jxk - Vehicle_X.Integrator_CSTATE_p[3] *
    Vehicle_B.VectorConcatenate_a[1];
  rtb_Product2_l_tmp = Vehicle_X.Integrator_CSTATE_p[3] *
    Vehicle_B.VectorConcatenate_a[0] - Vehicle_B.ixk;
  rtb_Fcn = Vehicle_B.ixj - Vehicle_B.jxi;
  for (i = 0; i < 3; i++) {
    rtb_VectorConcatenate_ml[i] = rtb_VectorConcatenate_l[3 * i + 2] * rtb_Fcn +
      (rtb_VectorConcatenate_l[3 * i + 1] * rtb_Product2_l_tmp +
       rtb_VectorConcatenate_l[3 * i] * rtb_Product_e_tmp);
  }
   ...
   *  Sum: '<S29>/Add4'
   */
  Vehicle_Y.XYVelocities[0] = Vehicle_B.yOut[4] + rtb_VectorConcatenate_ml[0];
  Vehicle_Y.XYVelocities[1] = Vehicle_B.yOut[5] + rtb_VectorConcatenate_ml[1];
  ...
  Vehicle_Y.YawAngle = 57.295779513082323 * Vehicle_X.Integrator_CSTATE_p[2];
  ...
  /* Unit Conversion - from: rad/s to: deg/s
     Expression: output = (57.2958*input) + (0) */
  Vehicle_Y.YawRate = 57.295779513082323 * Vehicle_X.Integrator_CSTATE_p[3];
   ...
   *  Sum: '<S82>/Sum'
   */
  Vehicle_B.Product1 = (alfa_f - Vehicle_X.lateral_CSTATE) *
    rtb_VectorConcatenate1_p_idx_0 / Vehicle_P.VehicleBody3DOFSingleTrack_sigm;
   ...
   *  Sum: '<S83>/Sum'
   */
  Vehicle_B.Product1_j = (alfa_r - Vehicle_X.lateral_CSTATE_e) * rtb_Sum /
...
void Vehicle_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE_p[0] = Vehicle_B.stateDer[0];
  _rtXdot->Integrator_CSTATE_p[1] = Vehicle_B.stateDer[1];
  _rtXdot->Integrator_CSTATE_p[2] = Vehicle_B.stateDer[2];
  _rtXdot->Integrator_CSTATE_p[3] = Vehicle_B.stateDer[3];
...
void Vehicle_initialize(void)
{
  ...
  /* Setup for data logging */
  {
    ...
    rtliSetLogFormat(Vehicle_M->rtwLogInfo, 2);
  ...
  if (rtmIsFirstInitCond(Vehicle_M)) {
    ...
    Vehicle_X.Integrator_CSTATE_p[0] = 0.0;
    Vehicle_X.Integrator_CSTATE_p[1] = 0.0;
    Vehicle_X.Integrator_CSTATE_p[2] = 0.0;
    Vehicle_X.Integrator_CSTATE_p[3] = 0.0;
  }

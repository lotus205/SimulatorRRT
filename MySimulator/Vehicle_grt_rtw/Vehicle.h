...
typedef struct {
  ...
  real_T VectorConcatenate1_c[2];      /* '<S60>/Vector Concatenate1' */
  real_T VectorConcatenate[4];         /* '<S86>/Vector Concatenate' */
...
typedef struct {
  ...
  int_T Integrator_IWORK_c;            /* '<S86>/Integrator' */
} DW_Vehicle_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE[2];         /* '<S28>/Integrator' */
  real_T Integrator_CSTATE_p[4];       /* '<S86>/Integrator' */
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_p[4];    /* '<S86>/Integrator' */
...
struct P_Vehicle_T_ {
  ...
  real_T BicycleModelVelocityInput_xdot_;/* Mask Parameter: BicycleModelVelocityInput_xdot_
                                          ...
                                          */
  real_T BicycleModelVelocityInput_xdo_c;/* Mask Parameter: BicycleModelVelocityInput_xdo_c
                                          * Referenced by: '<S2>/vehicle model'
                                          */
  ...
  real_T vehiclemodel_w[2];            /* Expression: w
                                        * Referenced by: '<S2>/vehicle model'
                                        */
  real_T Constant_Value;               /* Expression: mu
